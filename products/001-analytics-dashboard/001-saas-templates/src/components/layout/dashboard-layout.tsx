...
export function DashboardLayout() {
  return (
    <div className="flex min-h-svh flex-col bg-background" {...figma("Screen", { Type: "Dashboard" })}>
      <AppHeader />
      <main className="relative flex-1 p-md sm:p-xl lg:p-2xl">
        ...
        <div className="pointer-events-none absolute inset-0 overflow-hidden dark:block hidden" aria-hidden="true">
          ...
          <div className="absolute top-[40%] -left-[250px] size-[500px] rounded-full bg-primary/[0.02] blur-[180px]" />
        </div>
