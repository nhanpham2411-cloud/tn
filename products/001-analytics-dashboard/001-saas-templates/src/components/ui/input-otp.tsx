...
function InputOTPSlot({
  ...
  return (
    <div
      ...
      className={cn(
        "relative flex size-3xl items-center justify-center border-y border-r border-border-strong text-sm transition-all first:rounded-l-md first:border-l last:rounded-r-md",
